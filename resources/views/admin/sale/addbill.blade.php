...
<div class="col-md-4">
    <div class="form-group">
      ...
      <select class="form-control select2"  name="credit_debit" id="cus" onChange="get_cus_val()">
